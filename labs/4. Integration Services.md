...
> [!NOTE]
This lab has been lifted from the excellent "Azure Integration Services Workshop" content created by John Billiris, another Microsoft CSA. A link to the full repo is below. As well as the APIM content we are using here there are also labs on Logic Apps, Azure Functions, Event Grid and Azure Service Bus.
